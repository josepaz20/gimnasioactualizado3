...
function verResumenCaja(idCaja) {
    $.get('resumen', {idCaja: idCaja}, setFormulario);
    bloqueoAjax();
}
...
function verAgregarCaja() {
    $.get('registrarcaja', {}, setFormulario);
    bloqueoAjax();
}
...
function validarRegistrarCaja() {
    return confirm(" � DESEA CREAR LA CAJA DEL USUARIO ? ");
}

//------------------------------------------------------------------------------

function validarCerrarMiCaja() {
