...
class ProductosDAO extends AbstractTableGateway {

    protected $table = 'inventario_gimnasio4';
...
//------------------------------------------------------------------------------
    ...
    public function getRegistro($idRegistro = 1) {
        return new Movimientocaja2($this->select(array('idRegistro' => $idRegistro))->current()->getArrayCopy());
    }
      public function getServicioImprimir($idRegistro= 0) {
        $this->table = 'inventario_gimnasio4';
        $select = new Select($this->table);
        $select->columns(array(
             'idRegistro',
...
//------------------------------------------------------------------------------
    ...
    public function registrar(Movimientocaja2 $registroOBJ = null) {
        try {
            $this->table = 'inventario_gimnasio4';
...
//            echo $insert->getSqlString();
    ...
    public function editar(Movimientocaja2 $registroOBJ = null) {
        try {
            $this->table = 'inventario_gimnasio4';
