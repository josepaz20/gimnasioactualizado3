...
class FinanzasDAO extends AbstractTableGateway {

    protected $table = 'inventario_gimnasio2';
...
//------------------------------------------------------------------------------
    ...
    public function getRegistro($idRegistro = 1) {
        return new Movimientocaja($this->select(array('idRegistro' => $idRegistro))->current()->getArrayCopy());
    }
