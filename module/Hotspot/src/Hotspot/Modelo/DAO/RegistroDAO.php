...
class RegistroDAO extends AbstractTableGateway {

    protected $table = 'inventario_gimnasio';
...
//------------------------------------------------------------------------------
      ...
      public function getRegistro($idRegistro = 0) {
        return new Registro($this->select(array('idRegistro' => $idRegistro))->current()->getArrayCopy());
    }
...
//------------------------------------------------------------------------------
 ...
 public function registrar(Registro $registroOBJ = null) {
        try {
            $this->table = 'inventario_gimnasio';
...
//            echo $insert->getSqlString();
   ...
   public function editar (Registro $registroOBJ = null) {
        try {
            $this->table = 'inventario_gimnasio';
