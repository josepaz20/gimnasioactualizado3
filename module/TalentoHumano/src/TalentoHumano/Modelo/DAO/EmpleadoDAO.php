...
class EmpleadoDAO extends AbstractTableGateway {

    protected $table = 'gimnasio_empleado';
...
//------------------------------------------------------------------------------
    ...
    public function getRegistro($idRegistro = 0) {
        return new Empleado($this->select(array('idRegistro' => $idRegistro))->current()->getArrayCopy());
    }
...
//------------------------------------------------------------------------------
    ...
    public function registrar(Empleado $registroOBJ = null) {
        try {
            $this->table = 'gimnasio_empleado';
...
//            echo $insert->getSqlString();
    ...
    public function editar(Empleado $registroOBJ = null) {
        try {
            $this->table = 'gimnasio_empleado';
